    ...
    <body>
        ...
        <div class="container admin">
            ...
            <div class="col-md-12">
                ...
                <div onclick="window.location='index.jsp'" class="card">

                        <div class="card-body text-center">

                            <div class="container">
                                <img style="max-width: 125px" class="img-fluid rounded-circle" src="img/complete.gif" alt="user_icon"/>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="ProductOperationServlet" method="post" enctype="multipart/form-data">
                            ...
                            <!--product price-->
                            <div class="form-group">
                                <input type="number" class="form-control" placeholder="Enter the product price" name="pPrice" required >
                            </div>

                            <!--product discount-->
                            <div class="form-group">
                                <input type="number" class="form-control" placeholder="Enter the discount on the product" name="pDiscount" required >
                            </div>
                            ...
                            <!--product file-->
                            <div class="form-group">
                                <label for="pPic">Add product picture</label>
                                <br>
